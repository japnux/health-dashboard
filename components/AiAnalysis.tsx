  ...
  return (
    <>
      ...
      <div className="fixed bottom-5 right-5 z-50">
        ...
        <button
          onClick={() => setOpen((o) => !o)}
          className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[var(--color-brand-purple)] text-white flex items-center justify-center transition-transform hover:scale-105 active:scale-95"
          style={{
